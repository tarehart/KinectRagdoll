...
namespace FarseerPhysics.Factories
{
    public static class BodyFactory
    {
        ...
        public static Body CreateCircle(World world, float radius, float density,DebugMaterial userData)
        {
        ...
        public static Body CreateCircle(World world, float radius, float density, Vector2 position,DebugMaterial userData)
        {
            Body body = CreateBody(world, position);
        ...
        public static Body CreatePolygon(World world, Vertices vertices, float density,DebugMaterial userData)
        {
